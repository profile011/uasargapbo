                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_guestid, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txt_guestid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
...
//        txt_notelp.setEnabled(a);
    ...
    void updateForm() {
        if (!guest.isEmpty()) {
            txt_guestid.setText(guest.get(index).getGuest_ID());
            txt_namalengkap.setText(guest.get(index).getNama_Lengkap());
            txt_alamat.setText(guest.get(index).getAlamat());
            if (guest.get(index).getJenis_Kelamin()=="Laki-laki") {
                radio_lakilaki.setSelected(true);
                radio_perempuan.setSelected(false);
            } else if (guest.get(index).getJenis_Kelamin()=="Perempuan") {
                radio_lakilaki.setSelected(false);
                radio_perempuan.setSelected(true);
            }
            txt_noktp.setText(guest.get(index).getNo_KTP());
            txt_email.setText(guest.get(index).getEmail());
            txt_notelp.setText(guest.get(index).getNo_Telp()); 
        } else {
            clearForm();
        }
    }
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        // TODO add your handling code here:
        String guestid,namalengkap,alamat,kelamin,noktp,email,notelp;
        guestid=txt_guestid.getText();
        ...
        guest.add(new Guest(guestid,namalengkap,alamat,kelamin,noktp,email,notelp));
        toggleForm(false);
        clearForm();
        toggleButton(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormGuest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
