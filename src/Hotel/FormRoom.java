...
public class FormRoom extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_tipekamar, javax.swing.GroupLayout.PREFERRED_SIZE, 533, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_hargakamar, javax.swing.GroupLayout.PREFERRED_SIZE, 533, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_namakamar, javax.swing.GroupLayout.PREFERRED_SIZE, 533, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_roomid, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    ArrayList<Room> kamar = new ArrayList<Room>();
    int index = 0;
...
//        txt_notelp.setEnabled(a);
    ...
    void updateForm() {
        if (!kamar.isEmpty()) {
            txt_roomid.setText(kamar.get(index).getRoom_ID());
            txt_namakamar.setText(kamar.get(index).getNama_Kamar());
            txt_deskripsi.setText(kamar.get(index).getDeskripsi());
            txt_hargakamar.setText(Integer.toString(kamar.get(index).getHarga_Kamar()));
            txt_tipekamar.setText(kamar.get(index).getTipe_Kamar());
        } else {
            clearForm();
        }
    }
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        // TODO add your handling code here:
        String roomid, namakamar, deskripsi, tipekamar;
        int hargakamar;
        roomid = txt_roomid.getText();
        namakamar = txt_namakamar.getText();
        deskripsi = txt_deskripsi.getText();
        hargakamar = Integer.parseInt(txt_hargakamar.getText());
        tipekamar = txt_tipekamar.getText();
        kamar.add(new Room(roomid, namakamar, deskripsi, hargakamar, tipekamar));
        toggleForm(false);
        clearForm();
        toggleButton(true);
